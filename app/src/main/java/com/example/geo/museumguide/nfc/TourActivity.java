package com.example.geo.museumguide.nfc;
    ...
    private class NdefReaderTask extends AsyncTask<Tag, Void, String> {
        ...
        protected void onPostExecute(String result) {
            if (result != null) {
                ...
                mTextView.setText("No value!");
            }
            Long value = null;
            try{
                value = Long.valueOf(result);
            }catch(Exception ex){
                mTextView.setText("NFC tag value is not valid!");
                return;
            }

            new GetArtifactByIdAndShowTask(TourActivity.this).execute(value);
        }
    }
}
