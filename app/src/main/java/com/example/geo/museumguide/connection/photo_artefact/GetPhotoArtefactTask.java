...
public class GetPhotoArtefactTask extends AsyncTask<Object, Void, List<PhotoArtefact>> {

    private Activity source;
    private ArrayList<PhotoArtefact> artefacts;

    public GetPhotoArtefactTask(Activity source) {
        this.source = source;
        artefacts = new ArrayList<PhotoArtefact>();
    }

    public GetPhotoArtefactTask() {
    ...
    protected void onPostExecute(List<PhotoArtefact> artefactL) {
        ...
        intent.putExtra("artefactList",(Serializable) artefactL);
