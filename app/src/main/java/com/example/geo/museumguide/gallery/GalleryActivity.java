...
public class GalleryActivity extends Activity {
    ...
    private List<PhotoArtefact> albumList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        albumList = (List<PhotoArtefact>) getIntent().getSerializableExtra("artefactList");
        ...
        try {
            Glide.with(this).load(R.drawable.art_wall).into((ImageView) findViewById(R.id.backdrop));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
